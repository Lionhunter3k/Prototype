...
public struct Program
{
    static void Main(string[] args)
    {
        ...
        troll.Monster.Attack(ref player, ref troll.Monster);
        troll.Defend(ref player, ref troll);
        ...
        for (int i = 0; i < monsters.Length; i++)
        {
            ...
            if (i % 3 == 0)
            {
                Monster monster = new Monster(30, 10, 10, 20, 1);
    ...
    static void AllMonstersAttackCharacter(ref Character player, Monster[] monsters)
    {
        for (int i = 0; i < monsters.Length; i++)
        {
            ...
            monster.Attack(ref player, ref monster);
        }
    }
